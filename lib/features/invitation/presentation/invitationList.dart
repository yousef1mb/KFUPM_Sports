...
import 'package:kfupm_sports/features/invitation/presentation/invitaionCard.dart';

import '../data/invitation.dart';
      ...
      child: SingleChildScrollView(  // Wrap everything inside a SingleChildScrollView
        child: Column(
          ...
          children: [
            ...
            Container(
              height: MediaQuery.of(context).size.height/2,  //  dynamic height calculation
